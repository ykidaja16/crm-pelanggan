                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="action" id="pl_approve_{{ $item->id }}" value="approve" required
                                               onchange="updateApprovalBtn(this)">
                                        <label class="form-check-label text-success fw-semibold" for="pl_approve_{{ $item->id }}">
                                            ✅ Approve
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="action" id="pl_reject_{{ $item->id }}" value="reject"
                                               onchange="updateApprovalBtn(this)">
                                        <label class="form-check-label text-danger fw-semibold" for="pl_reject_{{ $item->id }}">
                                            ❌ Reject
                                        </label>
                                    </div>
                                </div>
